...
class SW(commands.Cog):
    ...
    async def person(self, ctx, person_id: int):
        ...
        await ctx.send("Hold on just one moment... This can take a bit.")
    ...
    async def people(self, ctx):
        ...
        await ctx.send("Grabbing people, please wait...  This may take a couple minutes.")
        data = []
        next = True
    ...
    async def planets(self, ctx):
        ...
        This command does take a bit."""
        await ctx.send("Grabbing planets, please wait...  This may take a couple minutes.")
        data = []
        next = True
    ...
    async def films(self, ctx):
        ...
        This command does take a bit."""
        await ctx.send("Grabbing films, please wait...  This may take a couple minutes.")
        data = []
        next = True
    ...
    async def starships(self, ctx):
        ...
        This command does take a bit."""
        await ctx.send("Grabbing starships, please wait...  This may take a couple minutes.")
        data = []
        next = True
    ...
    async def vehicles(self, ctx):
        ...
        This command does take a bit."""
        await ctx.send("Grabbing vehicles, please wait...  This may take a couple minutes.")
        data = []
        next = True
    ...
    async def _all_species(self, ctx):
        ...
        This command does take a bit."""
        await ctx.send("Grabbing species, please wait...  This may take a couple minutes.")
        data = []
        next = True
